...
QBCore.Functions.CreateCallback('A7-doorlock:server:setupDoors', function(_, cb)
	cb(Config.DoorList)
end)

QBCore.Functions.CreateCallback('A7-doorlock:server:checkItems', function(source, cb, items, needsAll)
...
RegisterNetEvent('A7-doorlock:server:updateState', function(doorID, locked, src, usedLockpick, unlockAnyway, enableSounds, enableAnimation, sentSource)
	...
	TriggerClientEvent('A7-doorlock:client:setState', -1, playerId, doorID, locked, src or false, enableSounds, enableAnimation)
	...
	SetTimeout(Config.DoorList[doorID].autoLock, function()
		...
		if Config.DoorStates[doorID] == nil then Config.DoorStates[doorID] = locked elseif Config.DoorStates[doorID] ~= locked then Config.DoorStates[doorID] = nil end
		TriggerClientEvent('A7-doorlock:client:setState', -1, playerId, doorID, true, src or false, enableSounds, enableAnimation)
	end)
end)

RegisterNetEvent('A7-doorlock:server:saveNewDoor', function(data, doubleDoor)
	local src = source
	...
	TriggerClientEvent('A7-doorlock:client:newDoorAdded', -1, configData, identifier, src)
end)
...
RegisterNetEvent('A7-doorlock:server:removeLockpick', function(type)
	local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Commands.Add('newdoor', Lang:t("general.newdoor_command_description"), {}, false, function(source)
	TriggerClientEvent('A7-doorlock:client:addNewDoor', source)
...
QBCore.Commands.Add('doordebug', Lang:t("general.doordebug_command_description"), {}, false, function(source)
	TriggerClientEvent('A7-doorlock:client:ToggleDoorDebug', source)
end, Config.CommandPermission)


-- ما اسامح اي شخص يحذف البرنت

print("^6A7 DoorLock^7 - By : ^7A7store - ^6discord.gg/vvShNG4WYf")
